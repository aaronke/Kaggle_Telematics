...
#output = open('/cshome/kzhou3/Dropbox/Telematics/submission/final/305_ada_RF.csv', 'w')
#output = open('/cshome/kzhou3/Dropbox/Telematics/submission/final/305_ada_ET.csv', 'w')
...
for k in range(1,size + 1):
    ...
    #clf_base = RandomForest(n_estimators=1888, max_depth=None, min_samples_split=1) # 0.90694, better than 171!
